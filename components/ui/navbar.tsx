            ...
            >
              <div className="container mx-auto px-6 py-6 space-y-4">
                ...
                <div className="pt-4 border-t border-white/10">
                  <button
                    onClick={openModal}
                    className="button-responsive inline-flex items-center gap-2 w-full bg-gradient-to-r from-primary to-highlight hover:from-primary/90 hover:to-highlight/90 text-white font-bold rounded-xl shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all duration-300 justify-center border-2 border-primary/20 hover:border-primary/40"
                  >
                    Join Waitlist
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
