...
LandLedger Technologies (“LandLedger,” “we,” “our,” “us”) uses cookies and similar technologies to improve your browsing experience, analyse site traffic, and ensure our services function securely.
This Cookie Policy complies with Ghana’s Data Protection Act, 2012 (Act 843) and, where applicable, the EU GDPR, UK GDPR, and California Consumer Privacy Act (CCPA).
Key Facts Summary
We use cookies to keep the site secure and functional.


Non-essential cookies (analytics, advertising) require your consent.
...
Essential cookies – Required for secure, core site functions (navigation, form submission).


Performance cookies – Help us analyse how visitors use our website.


Functionality cookies – Remember preferences such as language and location.


Advertising cookies – Used, with your consent, to deliver relevant adverts and measure campaign performance.
...
Privacy Policy
Last updated: [1st Sep 2025]
LandLedger Technologies (“LandLedger,” “we,” “our,” “us”) respects your privacy. We comply with Ghana’s Data Protection Act, 2012 (Act 843) under the oversight of the Data Protection Commission (DPC). For international users, we also align with the EU GDPR, UK GDPR, and CCPA where applicable.
Key Facts Summary
We collect data you share with us (like contact details and preferences).


We don’t sell your data.


Future services may require KYC/AML checks.
...
1. Data we collect
Personal details (name, email, phone, location, CV if applying for roles).


Investment preferences and responses in forms.


Technical data (IP address, browser type, device).


Communications data (emails, WhatsApp, if shared).


2. How we use your data
To provide information about our platform, waitlist, and talent pool.
...
Ghanaian regulators (SEC, BoG, DPC, RGD) if required.


Trusted service providers (hosting, email, analytics).


Legal advisers and compliance partners.
...
Terms of Service
Last updated: [1st Sep 2025]
Welcome to LandLedger. These Terms of Service (“Terms”) govern your use of our website (the “Site”) and services (the “Services”), operated by LandLedger Technologies (“LandLedger”).
Key Facts Summary
We are not currently offering, brokering, or issuing tokens.
...
Last updated: [1st Sep 2025]
Key Facts Summary
The Site is informational only — no tokens are for sale.


Future participation will require KYC/AML checks.


All investments carry risk, including the possibility of losing your entire capital.
...
The Securities and Exchange Commission of Ghana (SEC) under the Securities Industry Act, 2016 (Act 929).


The Bank of Ghana (BoG) under the Payment Systems and Services Act, 2019 (Act 987).
...
Bank of Ghana’s tiered KYC framework:


Tier 1: Basic KYC for mobile money users (low limits, USSD access).


Tier 2: Enhanced KYC for higher-value transactions.


Tier 3: Full KYC for advanced services and diaspora participation.


International AML/CTF standards, including the Financial Action Task Force (FATF) guidelines.
...
Project risks, including delays or failures.
...
Platform risk, as LandLedger remains in early development.
